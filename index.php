...
<div class="imgloading" style="z-index:100;"> </div>
<img  id="wp-media-image_layerC4E1D8CD5E092C221A66FE2E65788C5E" class="img_lazy_load paragraph_image"  data-original="http://tpl-cac847b.pic-tpl.websiteonline.cn/upload/2_8q9g.jpg" type="zoom" src="http://static.websiteonline.cn/website/template/default/images/blank.gif" style="width: 288px; height: auto;;" />
</div>
...
<div class="imgloading" style="z-index:100;"> </div>
<img  id="wp-media-image_layer94FAF6EDC3B0BFC1E5F39F24796EC7CD" class="img_lazy_load paragraph_image"  data-original="http://tpl-cac847b.pic-tpl.websiteonline.cn/upload/1_4vze.jpg" type="zoom" src="http://static.websiteonline.cn/website/template/default/images/blank.gif" style="width: 288px; height: auto;;" />
</div>
...
<div class="imgloading" style="z-index:100;"> </div>
<img  id="wp-media-image_layer50AB944666E19E7DC6CF70BEE9F4BFDD" class="img_lazy_load paragraph_image"  data-original="http://tpl-cac847b.pic-tpl.websiteonline.cn/upload/3_6d3h.jpg" type="zoom" src="http://static.websiteonline.cn/website/template/default/images/blank.gif" style="width: 288px; height: auto;;" />
</div>
...
$(function(){
	$('.wp-title_content').each(function(){
		...
		<div class="full_content" style="width:980px; position:absolute;left:0;top:0;margin-left: 0px;;height:322px;">
			<div id='layerA4650CAEE39E1043E87D503313668C14' type='title'  class='cstlayer' style='left: 0px; top: 12px; position: absolute; z-index: 100; width: 980px; height: 303px; display: block;'  mid="layerD441A3354AA10D42FF9432FD5CAAE51F"  fatherid='layerB554DEC61747E28230541747789A6B7A'   deg='0'><div class="wp-title_content" style="word-wrap: break-word; padding: 0px; border: 20px solid transparent; height: 263px; width: 940px; display: block; background-color: transparent;"><div><span style="color: rgb(51, 51, 51); font-size: 14px; line-height: 240%;"><?php echo $config['name'];?>以科技为导向，技术力量雄厚，产品质量稳定。公司引进先进技术的针织织造设备30余台，具有年产3000吨的生产能力。公司在保持原有产品（包括各种素色摇粒绒、压花摇粒绒、印花摇粒绒、蚂蚁布、保面单刷布、毛巾布、各种成分的平纹布、双面布、健康布、华夫格、鱼鳞布、卫衣绒布、网眼布、珠地布、罗纹布以及各种风格的提花布等一系列品种）外更注重于产品的研究与开发，积极致力于产业升级和技术改造投入。产品方向立足于功能性面料以及弹力面料、花色组织面料等的研发和生产，品种包括：吸湿快干、抗紫外线、抗静电、抗菌除臭、防水透气复合布、弹力平纹、弹力双面、弹力罗纹、弹力毛巾等，产品品种达数百种，主要销往深圳、广州等地，为全球各大知名品牌的运动休闲服装企业长期提供面料。</span></div><div><span style="color: rgb(51, 51, 51); font-size: 14px; line-height: 240%;">&nbsp; &nbsp; &nbsp;公司遵循“诚信经营、服务客户”为宗旨，以质量求生存，以科技求发展，坚持创新和科技产业化工作，随时把握时代的脉搏，力求走在同行的前列。公司拥有一支经严格培训，整体素质优良的员工队伍，完善的质量管理体系，做到根据客户要求制定严格的工艺及控制点，层层把关。良好的信誉已赢得众多客户的信赖，我公司将以一流的产品和一流的信誉展现“艺美”的风采，与广大客户携手共进，开创辉煌的未来！</span></div></div>
