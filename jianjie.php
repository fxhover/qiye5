...
initScrollcontainerHeight();	
	...
	<div id="canvas" style="border-bottom: 2px solid transparent;margin: 0 auto;width:980px;;height:966px">
...
<div id='layer4F0345FE3B6D3BF96229874E8B622B6C' type='title'  class='cstlayer' style='left: 414px; top: 626px; position: absolute; z-index: 102; width: 566px; height: 49px;'  mid="layerD441A3354AA10D42FF9432FD5CAAE51F"   deg='0'><div class="wp-title_content" style="word-wrap: break-word; padding: 0px; border: 7px solid transparent; height: 35px; width: 552px; display: block; background-color: transparent;"><div><span style="color: rgb(51, 51, 51); font-size: 16px; line-height: 240%;"><strong>&nbsp; 公司介绍</strong></span></div></div>
<script type="text/javascript">
$(function(){
...
</div><script>		         $('#layer4F0345FE3B6D3BF96229874E8B622B6C').triggerHandler('layer_ready');</script><div id='layer367436B35739AF4D4F45DDA4FD8CBA5F' type='title'  class='cstlayer' style='left: 0px; top: 678px; position: absolute; z-index: 103; width: 980px; height: 288px;'  mid=""   deg='0'><div class="wp-title_content" style="word-wrap: break-word; padding: 0px; border-color: transparent; border-width: 0px; height: 288px; width: 980px; display: block;"><div><span style="line-height: 240%; font-size: 14px;"><?php echo $config['name'];?> 成立于2003年11月7日，是一家主要从事舞台音响、灯光、视频设备代理、工程设计安装、舞台演出设备租赁的专业公司。
...
目前我公司主要代理的专业灯光音响品牌包括：JBL VT4887系列线阵列扬声器及配套设备、JBL工程系列扬声器、SHURE 无线话筒、CROWN功放、BSS处理器、BOSE工程系列扬声器、BOSE会议系列扬声器、BOSE处理器、QSC 网络音频矩阵Q-SYS、QSC PL系列功放、QSC 线性、天花、有源扬声器系列等等。同时我公司与其它国内外知名品牌的灯光音响供应商都有良好的合作关系。</span></div></div>
</div><script>		         $('#layer367436B35739AF4D4F45DDA4FD8CBA5F').triggerHandler('layer_ready');</script>	</div>	
